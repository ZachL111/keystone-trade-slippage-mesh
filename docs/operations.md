...
`keystone-trade-slippage-mesh` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for slippage systems, covering protocol validation, framed sample traffic, and failure-oriented tests.
...
The score is deterministic. The current threshold is 180. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 4.
