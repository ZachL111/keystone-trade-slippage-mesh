"""Regression checks for the keystone-trade-slippage-mesh casebook."""
...
from casebook.harness import assert_expected, keystone_trade_slippage_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_trade_slippage_mesh_summary(), assert_expected())
