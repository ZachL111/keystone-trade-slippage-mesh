...
$repo = "keystone-trade-slippage-mesh"
$language = "Zig"
$category = "Trading systems"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/keystone-trade-slippage-walkthrough.md")) {
